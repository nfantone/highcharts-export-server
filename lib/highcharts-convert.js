...
(function() {
  ...
  function render(params, exitCallback, exitErrorCallback) {
    ...
    function convert(svg) {
      var interval;
      var timer;
      var timeoutMsg = 'Timeout reached while downloading external resources. Remaining resources: ';
    ...
    function appendStyleElement(css, svg) {
      ...
      function insertCSSImports(css, head) {
        ...
        var imports = css.match(importRegex);
        var match;
        var url;
        var link;
        var i;
    ...
    function injectResources(resources, outType) {
      ...
      var fileName;
      var fileIdx;
      var svg = outType.toLowerCase() === 'svg';
      var extension;
  ...
  function startServer(host, port) {
    ...
    serverMode = true;
    console.log('info: [highcharts-convert]    OK, PhantomJS is ready.');
  }
